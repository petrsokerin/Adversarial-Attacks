...
def main():
    ...
    for alpha in tqdm([0.001, 0.01, 0.1, 1, 10, 100]):
        ...
        for model_id in range(1):
            ...
            aa_res_df.to_csv(f'results/Ford_A/Original/aa_res_Ford_A_{model_id}_alpha={alpha}.csv')
            with open(f'results/Ford_A/Original/rej_curves_dict_Ford_A_model_{model_id}_alpha={alpha}.pickle', 'wb') as file:
